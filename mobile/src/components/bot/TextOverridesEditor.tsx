...
const LABELS: Record<BotTextKey, string> = {
  ...
  b1ImageFallback: "נשלחה תמונה במקום טקסט (ישן)",
  mediaUnsupported: "תמונה/הקלטה — בקשה לטקסט",
  orderAskType: "סוג הזמנה",
  askName: "בקשת שם",
  askPhone: "בקשת טלפון",
  askPhoneDelivery: "בקשת טלפון (משלוח)",
  ...
  askNotesDetailPickup: "פירוט הערות (איסוף)",
  askNotesDetailDelivery: "פירוט הערות (משלוח)",
  invalidQuantity: "כמות לא תקינה",
  orderSummaryIntro: "פתיחת מסך סיכום",
  orderSummaryConfirmQuestion: "שאלת אישור בסיכום",
  orderSummaryNoBooks: "אין ספרים בסיכום",
  orderEditListTitle: "כותרת תפריט עריכה",
  orderEditBooksTitle: "כותרת עריכת ספרים",
  orderCancelled: "ביטול הזמנה",
...
const GROUPS: { title: string; keys: BotTextKey[] }[] = [
  ...
  { title: "בירור מלאי", keys: ["b1AskTitle", "b1ManyMatches", "b1NoMatch", "mediaUnsupported", "b1ImageFallback"] },
  {
    title: "הזמנה",
    keys: [
      "orderAskType", "askName", "askPhone", "askPhoneDelivery", "invalidPhone", "askAddress", "askDeliveryMethod",
      "askBookTitle", "askQuantity", "askMore", "askNotesPickup", "askNotesDelivery",
      "askNotesDetailPickup", "askNotesDetailDelivery",
      "invalidQuantity",
      "orderSummaryIntro", "orderSummaryConfirmQuestion", "orderSummaryNoBooks",
      "orderEditListTitle", "orderEditBooksTitle", "orderCancelled",
      "orderDonePickup", "orderDoneDelivery",
    ],
  },
