...
import { CenterState, LabeledInput, SaveBar } from "./BotFormControls";

/** טופס עריכת פרטי החנות (`store_info`) — נשמר כחלק מהקונפיג המלא. */
export function StoreInfoEditor(): JSX.Element {
  ...
  const onSave = async (): Promise<void> => {
    ...
    try {
      await saveMutation.mutateAsync({ ...configQuery.data, store_info });
